...
const posts = [
  { id: 1, title: 'Teeth Whitening Tips for a Brighter Smile', slug: 'teeth-whitening-tips', category: 'Cosmetic', excerpt: 'Learn professional techniques and at-home tips to achieve and maintain a bright, white smile.', date: '2025-01-15', image: '/blog-teeth-whitening.jpg' },
  { id: 2, title: 'The Complete Flossing Guide', slug: 'flossing-guide', category: 'Preventive', excerpt: 'Master the art of flossing with our comprehensive guide covering technique, frequency, and benefits.', date: '2025-01-10', image: '/blog-flossing.jpg' },
  { id: 3, title: 'Orthodontics for Adults: It\'s Never Too Late', slug: 'adult-orthodontics', category: 'General', excerpt: 'Discover why more adults are choosing orthodontic treatment and the options available today.', date: '2025-01-08', image: '/blog-orthodontics.jpg' },
  { id: 4, title: 'Understanding Dental Implants', slug: 'dental-implants', category: 'General', excerpt: 'A detailed overview of dental implants, their benefits, and what to expect during treatment.', date: '2025-01-05', image: '/blog-implants.jpg' },
  { id: 5, title: 'Your Child\'s First Dental Visit', slug: 'first-dental-visit', category: "Children's", excerpt: 'Prepare your child for their first dental appointment with helpful tips and what to expect.', date: '2024-12-28', image: '/blog-child-visit.jpg' },
  { id: 6, title: 'Managing Dental Anxiety', slug: 'dental-anxiety', category: 'General', excerpt: 'Practical strategies to overcome dental anxiety and make your visits comfortable and stress-free.', date: '2024-12-22', image: '/blog-anxiety.jpg' },
]

const categories = ['All', 'General', 'Cosmetic', 'Preventive', "Children's"]
            ...
            <div className="flex flex-wrap gap-3">
              {categories.map((cat) => (
                <button
                  ...
                  style={category !== cat ? { background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.2)' } : {}}
                >
                  {cat}
                </button>
              ))}
                    ...
                    <div className="group glass-heavy rounded-3xl overflow-hidden hover:-translate-y-2 transition-all duration-500 hover:bg-white/25 shine-on-hover h-full flex flex-col">
                      ...
                      <div className="relative h-48 overflow-hidden">
                        ...
                        <div className="absolute top-4 left-4">
                          <span className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-bold text-white bg-gradient-to-r ${categoryColors[post.category] || 'from-blue-400 to-cyan-500'} shadow-lg`}>
                      ...
                      <div className="p-6 flex-1 flex flex-col">
                        <h3 className="text-lg font-bold text-white mb-3 leading-snug group-hover:text-cyan-200 transition-colors">{post.title}</h3>
                        <p className="text-white/65 text-sm mb-5 leading-relaxed flex-1">{post.excerpt}</p>
