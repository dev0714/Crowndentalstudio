      ...
      <div className="max-w-7xl mx-auto space-y-5">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-4">
          {BUCKETS.map(({ key, label }, i) => {
            const gradients = ['from-[#4b5563] to-[#1f2937]','from-navy-800 to-ink','from-amber-500 to-orange-400','from-orange-600 to-red-500','from-red-600 to-rose-500','from-rose-700 to-pink-600'];
            return (
